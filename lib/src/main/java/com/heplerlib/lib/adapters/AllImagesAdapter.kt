...
class AllImagesAdapter(private val context: Context, private val items: List<ImageFile>, private val itemClickListener: ItemClickListener, private var totalSelected: Int) :
